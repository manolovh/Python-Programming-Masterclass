...
rbValue.set(3)
# Radio buttons
radio_1 = tkinter.Radiobutton(optionFrame, text="Filename", value=1, variable=rbValue)
radio_2 = tkinter.Radiobutton(optionFrame, text="Path", value=2, variable=rbValue)
radio_3 = tkinter.Radiobutton(optionFrame, text="Timestamp", value=3, variable=rbValue)
...
yearSpinner = tkinter.Spinbox(dateFrame, width=5, from_=2000, to=2022)
