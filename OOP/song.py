...
class Artist:
    ...
    Attributes:
        ...
        albums (List[Album]): A list of the albums by the artist.
            ...
            not the exhaustive list of the artist's published albums.
    ...
    def add_song(self, name, year, title):
        ...
        A new album will be created in the collecting if it doesn't already exist.
...
def load_data():
    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            # data row should consist of (artist, album, year and a song)
