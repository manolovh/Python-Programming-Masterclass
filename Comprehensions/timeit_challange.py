...
print(timeit.timeit('[func(100) for func in (fact, factorial)]', number=10000, globals=globals()))
print(timeit.timeit('[func(100) for func in (factorial, fact)]', number=10000, globals=globals()))
