...
# nested_table = [(i, i * j) for i in range(1, 11) for j in range(1, 11)]
# for i, j in nested_table:
#     print(i, j)

for x, y in [(i, i * j) for i in range(1, 11) for j in range(1, 11)]:   # ^ a simpler solution to the one above ^
    print(x, y)
